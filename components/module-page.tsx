...
import { LADDER, MODULE_DEPTH_LABELS } from "@/lib/ladder";
      ...
      <div className="mt-3 divide-y divide-border border-y border-border">
        {guides.map((guide, index) => (
          <a
            ...
            className="group grid grid-cols-[2rem_minmax(0,1fr)_auto] items-start gap-3 py-4"
          >
...
export function ModulePage({ module }: { module: CurriculumModule }) {
  ...
  const rungTouches = LADDER.filter((rung) => rung.modules[module.slug] !== "save");

  return (
    <main className="mx-auto w-full max-w-6xl overflow-x-hidden px-6 py-10 sm:py-16">
